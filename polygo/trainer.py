...
Date: 2019/07/28
"""
from polygo.callbacks import F1Score
from polygo.utils import NERSequence
...
class Trainer(object):
    ...
    Attributes:
        _model: Model.
        _preprocessor: Transformer. Preprocessing data for feature processing.
    """
    ...
    def train(self, x_train, y_train, x_valid=None, y_valid=None,
        ...
        Args:
            ...
            y_valid: list of training label data
            batch_size: Integer.
                Number of samples per gradient update.
                If unspecified, `batch_size` will default to 32.
            epochs: Integer. Number of epochs to train the model.
            verbose: Integer 0, 1 or 2. Verbosity mode.
                0 = silent, 1 = prgress bar, 2 = one line per epoch.
            callbacks: List of `keras.callbacks.Callback` instances.
                List of callbacks to apply during training
            shuffle: Boolean (whether to shuffle the training data         before each epoch). `shuffle` will default to True
        """
