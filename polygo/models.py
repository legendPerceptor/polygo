...
from polygo.layers import CRF

def save_model(model, weights_file, params_file):
    """Since training is very time consuming, use functions provided by Keras to save model
    Args: 
        model: the keras model to be saved
        weigths_file: the path to save weights
        params_file: the path to save parameters.
    """
...
def load_model(weights_file, params_file):
    """Paired with save_model, the weights and model representations can be saved
    Args: 
        weigths_file: the path to load weights
        params_file: the path to load parameters.
    """
...
class BiLSTMCRF(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            word_embedding_dim (int): word embedding dimesions
            char_embedding_dim (int): character embedding dimensions
            word_lstm_size (int): word tagger LSTM output dimensions
