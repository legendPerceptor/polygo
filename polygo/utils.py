...
class Vocabulary(object):
    """Vovabulary maps tokens to ints
    ...
    def __init__(self, max_size=None, lower=True, unk_token=True, specials=('<pad>',)):
        ...
        Args:
            ...
            specials: The list of special tokens (e.g., padding or eos) will be prepended to the vocabulary
        """
    ...
    def token_to_id(self, token):
        ...
        Returns:
            int: int id of token
        """
        token = self.process_token(token) #The last one is unknown
